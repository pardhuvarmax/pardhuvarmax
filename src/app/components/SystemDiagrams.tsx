                ...
                return (
                    <svg viewBox="0 0 400 240" className="w-full h-full opacity-70">
                        ...
                        {[70, 150, 230, 310].map((x, i) => (
                            <g key={i}>
                                <line x1={x} y1="90" x2={x} y2="130" stroke="var(--text-muted)" strokeWidth="0.5" />
                                <motion.circle
                        ...
                        <rect x="140" y="155" width="120" height="35" rx="2" fill="none" stroke="var(--text-muted)" strokeWidth="0.8" strokeDasharray="3 3" />
                        ...
                        {[0, 1, 2].map((i) => {
                            ...
                            return (
                                <motion.g key={i}>
                                    <circle cx={cx} cy="212" r="9" fill="var(--bg-surface)" stroke="var(--accent-color)" strokeWidth="0.6" />
                                    <motion.circle
            ...
            default:
                return (
                    <svg viewBox="0 0 400 240" className="w-full h-full opacity-40">
                        <path d="M50,120 Q200,20 350,120 T50,120" fill="none" stroke="var(--accent-color)" strokeWidth="0.5" strokeDasharray="2 2" />
